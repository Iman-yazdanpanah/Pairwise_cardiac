...
class CustomDataset(Dataset):
    ...
    def get_image_paths(self):
        return [os.path.join(self.image_dir, self.data.iloc[i, 0] + '.png') for i in range(len(self.data))]
...
dataset = CustomDataset(csv_file='./train/train.csv', image_dir='./train/images', mask_dir='./train/masks', transform=transform)
